...
const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gradient-glow animate-pulse-glow" style={{
      animationDelay: "1.5s"
    }} />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Greeting */}
          <p className="text-primary font-medium mb-4 animate-fade-up" style={{
          animationDelay: "0.1s"
        }}>
            Hello, I'm
          </p>
          ...
          {/* Name */}
          <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-bold mb-6 animate-fade-up" style={{
          animationDelay: "0.2s"
        }}>
            Renuka Prasad
          ...
          {/* Title */}
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 animate-fade-up" style={{
          animationDelay: "0.3s"
        }}>Software Developer & Data Scientist</p>
          
          {/* Description */}
          <p className="text-muted-foreground max-w-2xl mx-auto mb-10 animate-fade-up" style={{
          animationDelay: "0.4s"
        }}>Passionate about building scalable microservices, RESTful APIs, Data Science and full-stack applications. Currently pursuing B.E in Electronics and Communications at M.S Ramaiah Institute of Technology.</p>
